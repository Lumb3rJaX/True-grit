...
//Allows the bot to add roles to users accounts
if (command === "addrole") {
let role= message.guild.roles.find(r=> r.name === "Maps");
//this bit lets you mention the user to add the role to them (;addrole @user Role Name);
